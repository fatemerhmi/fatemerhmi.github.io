...
const skillLevels: Record<string, number> = {
  Python: 80,
  SQL: 50,
  "Hugging Face Transformers": 85,
  "RAG pipelines": 85,
  "LangChain / LangGraph": 65,
  "Multi-agent orchestration": 70,
  "Agentic workflows": 70,
  "Human-in-the-loop systems": 75,
  "Prompt engineering": 80,
  "LLM evaluation": 80,
  PyTorch: 80,
  "scikit-learn": 70,
  MLflow: 60,
  "Model fine-tuning (PEFT / LoRA)": 50,
  spaCy: 60,
  NLTK: 75,
  "Document understanding": 85,
